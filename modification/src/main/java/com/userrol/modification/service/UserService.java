...
public interface UserService {
    ...
    User assignRole(Long id, Role role);   //este negrito de aca es para chantarle el rol manualmente a los tecnicos o AL admin por si preguntan en la presentación
